...
def predict():
    ...
    prediction = lr(Engine_Size, Cylinders, Fuel_Consumption_City, Fuel_Consumption_Hwy, Fuel_Consumption_Comb,
                    ...
                    Transmission_AM7, Transmission_AM8, Transmission_AM9, Transmission_AS10, Transmission_AS4, Transmission_AS5,
                    Transmission_AS6, Transmission_AS7, Transmission_AS8, Transmission_AS9, Transmission_AV, Transmission_AV10,
                    Transmission_AV6, Transmission_AV7, Transmission_AV8, Transmission_M5, Transmission_M6, Transmission_M7,
                    Make_Type_Luxury, Make_Type_Premium, Make_Type_Sports, Vehicle_Class_Type_SUV, Vehicle_Class_Type_Sedan,
                    Vehicle_Class_Type_Truck)
    
    government_requirements = 150  # Example value, replace it with the actual government requirement

    if prediction > government_requirements:
        suggestion = "Your selected car model may emit more CO2 than the government requirements. "
        
         
    else:
        suggestion = "Your selected car model does not meet the government requirements for CO2 emissions. Good choice!"
